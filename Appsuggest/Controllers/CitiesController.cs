...
namespace Appsuggest.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Name,StateId")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Name,StateId")] City city)
        {
            if (ModelState.IsValid)
            {
